 ...
 * 
 * <p>
 * {@link FareRegisterSessionHelper} is typically used in combination with
 ...
 * @since 3.2
 */
public class FareRegisterSessionHelper {
     ...
     */
    public FareRegisterSessionHelper(SessionRegistry sessionRegistry) {
     ...
     */
    public void register(Authentication authentication, HttpServletRequest request, HttpServletResponse response) {
