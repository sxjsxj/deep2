...
public class FundRequirementFollowerCombineQueryModel extends QueryModel{
    ...
    private FundRequirementFollowerQueryModel fundRequirementFollowerQueryModel = new FundRequirementFollowerQueryModel();
	...
	public FundRequirementQueryModel getFundRequirementQueryModel() {
		return fundRequirementQueryModel;
	}

	public void setFundRequirementQueryModel(FundRequirementQueryModel fundRequirementQueryModel) {
	...
	public FundRequirementFollowerQueryModel getFundRequirementFollowerQueryModel() {
		return fundRequirementFollowerQueryModel;
	}

	public void setFundRequirementFollowerQueryModel(FundRequirementFollowerQueryModel fundRequirementFollowerQueryModel) {
		this.fundRequirementFollowerQueryModel = fundRequirementFollowerQueryModel;
	}
