...
public class FundRequirementFollowerQueryModel extends QueryModel {
	private FundRequirementFollowerIdQueryModel fundRequirementFollowerIdQueryModel;
	...
	public FundRequirementFollowerIdQueryModel getFundRequirementFollowerIdQueryModel() {
		return this.fundRequirementFollowerIdQueryModel;
	}

	public void setFundRequirementFollowerIdQueryModel(
			FundRequirementFollowerIdQueryModel fundRequirementFollowerIdQueryModel) {
		this.fundRequirementFollowerIdQueryModel = fundRequirementFollowerIdQueryModel;
	}
}
