...
public class InvestorUserFollowerQueryModel extends QueryModel {
	private InvestorUserFollowerIdQueryModel investorUserFollowerIdQueryModel;
	...
	public InvestorUserFollowerIdQueryModel getInvestorUserFollowerIdQueryModel() {
		return this.investorUserFollowerIdQueryModel;
	}

	public void setInvestorUserFollowerIdQueryModel(
			InvestorUserFollowerIdQueryModel investorUserFollowerIdQueryModel) {
		this.investorUserFollowerIdQueryModel = investorUserFollowerIdQueryModel;
	}
}
