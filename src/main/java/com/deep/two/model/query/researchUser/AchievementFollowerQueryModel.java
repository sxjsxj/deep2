...
public class AchievementFollowerQueryModel extends QueryModel {
	private AchievementFollowerIdQueryModel achievementFollowerIdQueryModel = new AchievementFollowerIdQueryModel() ;
    ...
    public AchievementFollowerIdQueryModel getAchievementFollowerIdQueryModel() {
		return this.achievementFollowerIdQueryModel;
	}

	public void setAchievementFollowerIdQueryModel(
			AchievementFollowerIdQueryModel achievementFollowerIdQueryModel) {
		this.achievementFollowerIdQueryModel = achievementFollowerIdQueryModel;
	}
