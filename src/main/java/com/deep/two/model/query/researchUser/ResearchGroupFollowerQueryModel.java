...
public class ResearchGroupFollowerQueryModel extends QueryModel {
	private ResearchGroupFollowerIdQueryModel researchGroupFollowerIdQueryModel;
	...
	public ResearchGroupFollowerIdQueryModel getResearchGroupFollowerIdQueryModel() {
		return this.researchGroupFollowerIdQueryModel;
	}

	public void setResearchGroupFollowerIdQueryModel(
			ResearchGroupFollowerIdQueryModel researchGroupFollowerIdQueryModel) {
		this.researchGroupFollowerIdQueryModel = researchGroupFollowerIdQueryModel;
	}
}
