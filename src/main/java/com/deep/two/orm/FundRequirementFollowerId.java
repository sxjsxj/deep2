...
/**
 * FundRequirementFollowerId generated by hbm2java
 */
public class FundRequirementFollowerId implements java.io.Serializable {

	private String userId;
	private String requirementId;
	private String relationType;

	public FundRequirementFollowerId() {
	}

	public FundRequirementFollowerId(String userId, String requirementId,
			String relationType) {
		this.userId = userId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FundRequirementFollowerId))
			return false;
		FundRequirementFollowerId castOther = (FundRequirementFollowerId) other;
