...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/front/authority/submitPassword.js"></script>
</head>
<body>
	...
	<!-- version3 点击发布需求弹框start -->
			<div id="altstwo">
				<div class='xuqiualert' style="width:740px;margin-left:-370px;margin-top:15px;font-size: 24px;text-align:center;color:#434343;min-height:280px;">
					...
					<div>
					     <div>
								<font size="5" color="#349fc4">密码已经修改请重新登录!</font>
						  </div>
					</div>
				</div>
			</div>
	...
	<div class='loginbg'>
		<div class='width1200'>
			...
			<div class='loginkuang' style="margin-top: -80px;">
				...
				<div class='loginbtns anniu' style="margin-top:5px;"><a href='#' url="${pageContext.request.contextPath}/security/user/resetPassword" id="send">确定</a></div>
				</form>
			</div>
		</div>
	</div>
