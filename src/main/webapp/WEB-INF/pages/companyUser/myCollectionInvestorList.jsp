...
<title>个人中心-企业-我的收藏的投资方列表</title>
<style type="text/css">
.mydiv1 {}
.mydiv2 {
...
<body>
	...
	<input id="opeationIdIndex" type="hidden" value=""></input>
			...
			<div style="margin-left:-50px;" class='fl right cons listd listps'>
				<div class='title' style="margin-top:-40px;font-size:17px;">我收藏的投资方</div>
				<ul style="margin-top:10px;margin-bottom:-10px;" class='heads'>
					...
					<li id="queryInvestor" url="${pageContext.request.contextPath}/investorUserFollower/query" class='selectbtn'>查询</li>
				</ul>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/front/companyUser/myCollectionInvestorList.js"></script>
</body>
