...
<body>
	...
	<div class='cons info'>
		...
		<!-- version4 点击发布需求弹框start -->
			<div id="altsthree" style="display:none">
				<div class='xuqiualert' style="margin-top:5px;width:740px;margin-left:-370px;font-size: 24px;text-align:center;color:#434343;min-height:280px;">
					<div class='tits'>
						保存失败
						<div class='imgs'>
							<img
			...
			<div style="width:938px;margin-left:-50px;" class='fl right'>
				...
				<ul class='conul'>
					...
					<div  id="getDetailUrl" url="${pageContext.request.contextPath}/companyUser/getDetail"></div>
					...
					<form id="emailForm">
						...
						<div href="javascript:;" class='updateInfoanniu' id="save" url="${pageContext.request.contextPath}/security/user/updateEmailTel"><a href="javascript:;">保存</a></div>
					</form>
					</li>
				</ul>
			</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/front/companyUser/updateMyPasswordInfo.js"></script>
</body>
