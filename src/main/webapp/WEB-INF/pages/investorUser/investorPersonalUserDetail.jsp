...
<body>
	...
	<div style="margin-left:-30px;">
		<form id="investorPersonalForm" method="post" enctype="multipart/form-data">
			...
			<div class='fl right'>
				...
				<div class='xuqiu xuqiu4'>
					...
					<div class='lis'>
						...
						<div class='fl input'>
							<input type='text'  maxlength="15" style="width:300px;" id="contactTel" name="contactTel" value=''/>
						</div>
				...
				<div class='xuqiu xuqiu6'>
					...
					<div class='fl'>
						...
						<div style="float:left;margin-top:9px;" id="investTypeCheckResult"></div>
				...
				<div class='xuqiu xuqiu3'>
					...
					<div class='fl'>
						<textarea name="investExperience"  maxlength="500" style="width:755px;" id="investExperience"></textarea>
					</div>
					<div class='clear'></div>
				</div>
				...
				<div class='xuqiu xuqiu3'>
					...
					<div class='fl'>
						<textarea name="investOutline"  maxlength="500" style="width:755px;" id="investOutline"></textarea>
					</div>
					<div class='clear'></div>
				</div>
