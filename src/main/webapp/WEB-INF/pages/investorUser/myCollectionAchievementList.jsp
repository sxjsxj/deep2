...
<%@ include file="/WEB-INF/pages/common/dialog.jsp" %>
	...
	<input id="opeationIdIndex" type="hidden" value=""></input>
			...
			<div class='title2'>
				...
				<ul style="float:right;" id="pagination" class='page'>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/front/investorUser/myCollectionAchievementList.js"></script>
</body>
