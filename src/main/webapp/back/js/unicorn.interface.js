...
//	});	
   ...
   $("#recommend-open-dialog").click(function(){
	...
	$("#noselect-open-modal").click(function(){
		$("#noselect-modal-dialog").dialog("open");
		return false;
	});
	 // Dialog message
	$("#noselect-modal-dialog").dialog({
		autoOpen: false,
		modal: true,
		buttons: {
			确定: function () {
	...
	$("#onlyoneselect-open-modal").click(function(){
		$("#onlyoneselect-modal-dialog").dialog("open");
		return false;
	});
	 // Dialog message
	$("#onlyoneselect-modal-dialog").dialog({
		autoOpen: false,
		modal: true,
		buttons: {
			确定: function () {
	...
	$("#returnInfo-open-modal").click(function(){
		$("#returnInfo-modal-dialog").dialog("open");
		return false;
	});
	 // Dialog message
	$("#returnInfo-modal-dialog").dialog({
		autoOpen: false,
		modal: true,
		buttons: {
			确定: function () {
