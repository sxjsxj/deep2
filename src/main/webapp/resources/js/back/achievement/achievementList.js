	...
	CommonFunction.baseOptions['success'] = function(datas) {
		...
		for(var i = 0; i < queryReturnList.length; i++) {	
			var achievementQueryTBodyTr = '<tr class="gradeX">'
				...
				+ '<td>'+ CommonFunction.setPatent(queryReturnList[i].patent) +'</td>'
                ...
                + '<td>'+ CommonFunction.setDetail(queryReturnList[i].applyTo) +'</td>'
                + '<td>'+ CommonFunction.setDetail(queryReturnList[i].expectedEffect) +'</td>'
