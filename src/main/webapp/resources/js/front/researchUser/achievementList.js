...
function query(param) {
	...
	FrontCommonFunction.baseOptions['success'] = function(datas) {
		...
		for(var i = 0; i < queryReturnList.length; i++) {
			...
			li+="</div></a>"
			li+="<div class='f'>"
			li+='<a href="'+moreInfoUrl+'" target="_blank"><div class="fl">'+FrontCommonFunction.setInvestorDomain(queryReturnList[i].domain)+"&nbsp;&nbsp;"+provinceName+"&nbsp;&nbsp;"+FrontCommonFunction.setAmount(queryReturnList[i].amount)+"&nbsp;&nbsp;"+FrontCommonFunction.setRequirementStatus(queryReturnList[i].status)+"</div></a>"
			li+='<div class="fr">'
